...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.iio_fmcomms2_source_0.set_params(self.freq, self.samp_rate, 20000000, True, True, True, 'manual', 64, 'manual', 64, 'A_BALANCED', '', True)
